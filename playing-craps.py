# playing-craps.py
# Emily Granatino 2 dice rolled 6 million times randomly, 
...
rollcraps = (frequency2 + frequency3 + frequency12)
wincraps = (frequency7 + frequency11)
...
print('Rolled craps',(rollcraps)/6000000)
print('Rolled win', (wincraps)/6000000)